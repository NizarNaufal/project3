...
public class AlarmCursorAdapter extends CursorAdapter {
    ...
    private ImageView mActiveImage, mThumnailImage;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        mThumnailImage = (ImageView) view.findViewById(R.id.thumbnail_image);
    ...
    public void setReminderTitle(String title) {
        ...
        mThumnailImage.setImageDrawable(mDrawableBuilder);
    }
